...
// Eos (새벽) 아이콘 - 브랜드 스토리용
export function EosIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      {/* 태양 */}
      <circle cx="12" cy="14" r="5" fill="currentColor" fillOpacity="0.2" stroke="currentColor" strokeWidth="1.5" />
      {/* 광선 */}
      <path d="M12 3v3M19 7l-2 2M21 14h-3M5 7l2 2M3 14h3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      {/* 지평선 */}
...
// Onyx (보석) 아이콘 - 브랜드 스토리용
export function OnyxIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      {/* 내부 반사 */}
      <path d="M2 9h20M7 9l5 13 5-13" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
}
